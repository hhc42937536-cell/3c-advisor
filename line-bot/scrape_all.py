...
THREADS_ACCOUNTS = [
    ...
    # ── 第二波美食帳號 ──
    {
        "username": "cindy._foodie",
        "city": "台北",
        "label": "Cindy美食",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["美食", "foodie", "位粉絲", "雙北"],
    },
    {
        "username": "weieatainan",
        "city": "台南",
        "label": "威吃台南",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["台南", "嘉義", "高雄", "位粉絲"],
    },
    {
        "username": "ccgotoeat",
        "city": "新竹",
    ...
    },
    {
        ...
        "label": "88cc美食",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["新竹", "台中", "打卡", "位粉絲"],
    },
    # ── 第三波：部落客 Threads 帳號（北中南東離島）──
    # 北部
    {
        "username": "bigfang_lohas",
        "city": "台北",
        "label": "樂活的大方",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["樂活", "美食", "住宿", "位粉絲"],
    },
    {
        "username": "rabbit38844",
        "city": "台北",
        "label": "小虎食夢網",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["小虎", "食夢", "巷弄", "位粉絲"],
    },
    {
        "username": "tenjochou",
        "city": "台北",
        "label": "周花花甲飽沒",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["周花花", "捷運", "台北", "位粉絲"],
    },
    {
        "username": "nash_gogogo",
        "city": "台北",
        "label": "Nash神之領域",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["Nash", "神之領域", "評論", "位粉絲"],
    },
    {
        "username": "viviyublog",
        "city": "桃園",
        "label": "VIVI桃園美食",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["Vivi", "桃園", "美食", "位粉絲"],
    },
    {
        "username": "peko721",
        "city": "新北",
        "label": "PEKO Simple Life",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["PEKO", "板橋", "銅板", "位粉絲"],
    },
    {
        "username": "mecocute2",
        "city": "新北",
    ...
    },
    {
        ...
        "label": "芽月女王",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["芽月", "龍潭", "中壢", "位粉絲"],
    },
    {
        "username": "timmyblog.cc",
        "city": "新竹",
        "label": "踢小米新竹",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["踢小米", "新竹", "在地", "位粉絲"],
    },
    # 中部
    {
        "username": "2hyperlife",
    ...
    },
    {
        ...
        "label": "飛天璇口袋名單",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["飛天璇", "口袋", "台中", "位粉絲"],
    },
    {
        "username": "candy_sky_tw",
        "city": "台中",
        "label": "棉花糖的天空",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["棉花糖", "台中", "早午餐", "位粉絲"],
    },
    {
        "username": "sant.tw",
        "city": "彰化",
        "label": "小涼美食小天地",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["小涼", "彰化", "鹿港", "位粉絲"],
    },
    {
        "username": "vivaweiblog",
        "city": "苗栗",
        "label": "瑋瑋美食萬歲",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["瑋瑋", "苗栗", "美食", "位粉絲"],
    },
    # 南部
    {
        "username": "boylondon_tainan",
        "city": "台南",
        "label": "倫敦男孩台南",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["倫敦男孩", "台南", "在地", "位粉絲"],
    },
    {
        "username": "decing.tw",
        "city": "台南",
        "label": "熱血玩台南",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["熱血", "台南", "懶人包", "位粉絲"],
    },
    {
        "username": "hoolee_foodie",
        "city": "高雄",
        "label": "虎麗笑嗨嗨",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["虎麗", "高雄", "在地", "位粉絲"],
    },
    {
        "username": "daisyyohoho",
        "city": "嘉義",
        "label": "黛西優遊自在",
        "default_cat": "吃喝玩樂",
        "bio_skip": ["黛西", "嘉義", "優遊", "位粉絲"],
    },
    {
        "username": "khfood8",
        "city": "高雄",
