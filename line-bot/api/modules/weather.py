...
_WEEKLY_DEALS = {
    0: [  # 星期一
        ("☕", "星巴克好友分享日", "每週一指定飲品買一送一，揪同事一起喝！記得開 APP 確認當週活動", "https://www.starbucks.com.tw/"),
        ("🏪", "7-11 週一集點加碼", "購買指定商品集 OPEN 點，週一常有加碼活動，開 APP 查今日優惠", "https://www.ibon.com.tw/"),
        ("🧋", "全家 FamiPort 繳費享點數", "繳費帳單順手在全家辦，享 FamilyCash 回饋點數，順便買杯咖啡", "https://www.family.com.tw/"),
        ("🛒", "全聯週一蔬果生鮮日", "週一生鮮蔬果常有折扣，下班順路補週間食材最划算", "https://www.pxmart.com.tw/"),
        ("🍔", "麥當勞 APP 週一優惠券", "打開麥當勞 APP 看本週優惠券，大麥克/麥脆雞常有特價", "https://www.mcdonalds.com.tw/"),
    ],
    1: [  # 星期二
        ("🏪", "7-11 週二甜點特賣", "City Café 拿鐵、御飯糰、三明治，週二不定期買一送一或特價", "https://www.7-eleven.com.tw/"),
        ("🧋", "CoCo 週二飲品優惠", "指定飲品第二杯折扣，下午茶時間揪人一起點，記得開官方 LINE", "https://www.coco-tea.com/"),
        ("🍕", "必勝客週二外帶特價", "外帶大披薩不定期特價，全家晚餐省荷包好選擇", "https://www.pizzahut.com.tw/"),
        ("📦", "momo 週二品牌日", "每週二有品牌館特價，美妝、家電、日用品都有折扣，開 APP 逛逛", "https://www.momoshop.com.tw/"),
        ("☕", "路易莎週二咖啡優惠", "美式、拿鐵常有週二限定價，會員 APP 確認今日特惠", "https://www.louisa.com.tw/"),
    ],
    2: [  # 星期三
        ("🍦", "全家霜淇淋買一送一", "週三不定期霜淇淋第二件半價或買一送一，下午點心時間到！", "https://www.family.com.tw/"),
        ("☕", "路易莎週三拿鐵優惠", "指定拿鐵系列週三特惠，提神解膩都靠它", "https://www.louisa.com.tw/"),
        ("🎬", "威秀影城週三半價", "每週三特定場次半價，下班看場電影最適合", "https://www.vscinemas.com.tw/"),
        ("🛒", "Costco 週三特價品更新", "Costco 會員每週三更新特價商品，APP 先看好清單再出門", "https://www.costco.com.tw/"),
        ("🍣", "壽司郎/爭鮮週三優惠", "不定期推出 10 元壽司或限時特價，注意官方 Instagram 公告", "https://www.sushiro.com.tw/"),
    ],
    3: [  # 星期四
        ("🍗", "KFC 瘋狂星期四", "每週四 V 我 50！指定套餐超值限定，肯德基 APP 確認今日品項", "https://www.kfc.com.tw/"),
        ("☕", "星巴克 APP 會員日", "每週四 Starbucks APP 常有隱藏優惠或買一送一，記得打開確認", "https://www.starbucks.com.tw/"),
        ("🛍️", "蝦皮週四免運日", "滿額免運門檻降低，囤貨、補日用品趁今天衝單", "https://shopee.tw/"),
        ("🏪", "7-11 週四霜淇淋特價", "部分門市週四霜淇淋有優惠，順便買杯咖啡，超商下午茶最省", "https://www.7-eleven.com.tw/"),
        ("🧺", "無印良品會員週四優惠", "MUJI 會員常有週四限定折扣，文具、收納、保養品都值得逛", "https://www.muji.com/tw/"),
    ],
    4: [  # 星期五
        ("🛵", "foodpanda 週五外送折扣", "週五晚餐用 foodpanda 訂外送，常有滿額折或免運碼，在家輕鬆吃", "https://www.foodpanda.com.tw/"),
        ("🚗", "Uber Eats 週五優惠", "週五外送滿額折扣碼，疲倦不想出門首選，開 APP 查今日優惠", "https://www.ubereats.com/tw"),
        ("🏪", "全家週五麵包甜點買一送一", "週五下午全家不定期麵包、甜點買一送一，下班順路帶走", "https://www.family.com.tw/"),
        ("🧴", "UNIQLO 新品上架日", "每週五 UNIQLO 上架新品或限時折扣，線上先看好再去店面", "https://www.uniqlo.com/tw/"),
        ("☕", "cama café 週五外帶優惠", "週五外帶拿鐵、美式有優惠，犒賞努力了一週的自己", "https://www.cama-cafe.com.tw/"),
    ],
    5: [  # 星期六
        ("🧺", "IKEA 週末家庭優惠", "假日帶家人去逛，吃肉丸午餐最幸福，APP 先確認本週特價商品", "https://www.ikea.com/tw/"),
        ("🏪", "全聯週六採購日", "週末補滿整週食材，生鮮、熟食、零食一次買齊", "https://www.pxmart.com.tw/"),
        ("🌿", "無印良品假日逛逛", "MUJI 週末門市人少的早上去最舒服，保養品、食品區必逛", "https://www.muji.com/tw/"),
        ("☕", "路易莎假日外帶", "假日外出帶杯咖啡最自在，會員點數累積中，衝一杯", "https://www.louisa.com.tw/"),
        ("🎪", "假日市集/農夫市集", "Google「你的城市＋週末市集」找今週活動，新鮮食材加文創小物", "https://www.google.com/search?q=台灣週末市集"),
    ],
    6: [  # 星期日
        ("🛒", "家樂福週日生鮮特價", "週日家樂福常有生鮮促銷，一週採買趁今天，肉品蔬果補足", "https://www.carrefour.com.tw/"),
        ("🍳", "全家週日早餐輕食", "週日早上去全家買早餐，咖啡加三明治不到 80 元，假日也有早餐", "https://www.family.com.tw/"),
        ("🧺", "IKEA 週日餐廳優惠", "週日 IKEA 餐廳早上人少，肉丸＋軟冰淇淋，假日家庭活動首選", "https://www.ikea.com/tw/"),
        ("📚", "誠品書店週日悠閒逛", "週日下午去誠品，也許有作家活動或新書展覽，買書還可累積點數", "https://www.eslite.com/"),
        ("🏪", "7-11 週日咖啡寄杯優惠", "City Café 週日不定期寄杯折扣，買多罐先存起來，每天一杯最省", "https://www.7-eleven.com.tw/"),
    ],
}
...
_SURPRISES_FALLBACK = [
    ("🏪", "超商每日好康", "7-11 / 全家 / 萊爾富 APP 每天更新優惠，開起來查查今日有沒有你要的", "https://www.7-eleven.com.tw/"),
    ("☕", "今天來杯咖啡", "路易莎、cama、星巴克 APP 會員常有驚喜折扣，今天是好喝咖啡的一天", "https://www.louisa.com.tw/"),
    ("🛵", "外送優惠碼", "foodpanda / Uber Eats 今日優惠碼，開 APP 查首頁 Banner，晚餐省一波", "https://www.foodpanda.com.tw/"),
    ("🧴", "無印良品會員優惠", "MUJI 會員不定期推全品項折扣，保養品、收納、食品一次補齊", "https://www.muji.com/tw/"),
    ("🛒", "全聯 PX Pay 回饋", "用 PX Pay 付款享額外點數回饋，消費 100 元累積點數不間斷", "https://www.pxmart.com.tw/"),
    ("📦", "蝦皮每日簽到領金幣", "每天開蝦皮簽到領金幣，累積兌換折價券，買東西更划算", "https://shopee.tw/"),
]
