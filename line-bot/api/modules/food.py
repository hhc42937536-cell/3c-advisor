...
if not _STYLE_KEYWORDS:
    ...
    "輕食": ["輕食", "沙拉", "健康", "低卡", "減脂", "清爽", "優格", "燕麥",
             "水煮餐", "無糖", "蛋白質", "健身餐", "貝果"],
    "港式": ["港式", "飲茶", "港點", "燒臘", "粵式", "叉燒"],
    "燒烤": ["燒烤", "烤肉", "串燒", "炭烤", "烤雞", "BBQ"],
    "義式": ["義式", "披薩", "pasta", "燉飯", "焗烤"],
}  # fallback — 順序同 JSON，台式早餐/西式早餐/粥/麵包蛋糕/拉麵/素食 在 JSON 開頭
# 扁平化所有食物關鍵字（供入口觸發用）
...
if not _CITY_SPECIALTIES:
    ...
    "台北": [
        ...
        {"name": "地瓜球", "desc": "士林夜市必炸，外酥內Q一捏就彈牙", "key": "台北 地瓜球", "s": ""},
        {"name": "蔥油餅", "desc": "街頭現烤蔥油餅，蔥花酥脆香氣四溢", "key": "台北 蔥油餅", "s": ""},
        {"name": "芒果冰", "desc": "冰館、師園頂級芒果剉冰，夏日排隊名物", "key": "台北 芒果冰", "s": "hot"},
        {"name": "蚵仔麵線", "desc": "廟口或夜市必點，蚵仔加大腸配濃稠麵線", "key": "台北 蚵仔麵線", "s": ""},
        {"name": "台北牛肉麵", "desc": "林東芳、老張等百年名店，紅燒湯頭濃郁霸氣", "key": "台北 牛肉麵", "s": ""},
    ],
    "新北": [
        ...
        {"name": "三峽碧螺春", "desc": "三峽茶區清香碧螺春，泡來配點心超雅緻", "key": "三峽 碧螺春 茶", "s": ""},
        {"name": "瑞芳螃蟹", "desc": "瑞芳漁港清蒸或三杯螃蟹，秋蟹最肥美", "key": "瑞芳 螃蟹 海鮮", "s": "cold"},
        {"name": "板橋湖州粽", "desc": "板橋湖州式長粽，竹葉香配鹹蛋黃超過癮", "key": "板橋 湖州粽", "s": ""},
        {"name": "新店碧潭烤肉", "desc": "碧潭河畔烤肉聖地，假日人氣爆棚", "key": "新店 碧潭 烤肉", "s": ""},
    ],
    "基隆": [
        ...
        {"name": "廟口蚵仔麵線", "desc": "基隆廟口招牌，蚵仔肥美加濃稠羹湯入味", "key": "基隆廟口 蚵仔麵線", "s": ""},
        {"name": "紅燒鰻羹", "desc": "廟口老店炸鰻魚配濃郁紅燒羹，鮮甜下飯", "key": "基隆廟口 紅燒鰻", "s": ""},
        {"name": "甜不辣", "desc": "廟口現炸甜不辣，魚漿Q彈沾醬超對味", "key": "基隆 甜不辣", "s": ""},
        {"name": "一口香腸", "desc": "廟口迷你香腸串，現烤爆汁一口一個停不下來", "key": "基隆廟口 香腸", "s": ""},
    ],
    "桃園": [
        ...
        {"name": "大溪花生豆腐", "desc": "大溪特有花生豆腐，口感滑嫩微甜，沾醬超香", "key": "大溪 花生豆腐", "s": ""},
        {"name": "中壢玉米", "desc": "中壢夜市現烤玉米，甜脆多汁超受歡迎", "key": "中壢 玉米 夜市", "s": ""},
        {"name": "客家鹹湯圓", "desc": "龍潭傳統鹹湯圓，油蔥蝦米配手工湯圓暖胃", "key": "桃園 客家 鹹湯圓", "s": "cold"},
        {"name": "大溪滷味", "desc": "大溪老街豆干、滷蛋、滷豆皮，百年老店必試", "key": "大溪 滷味 老街", "s": ""},
    ],
    "新竹": [
        ...
        {"name": "峨眉擂茶", "desc": "客家擂茶研磨現喝，配茶食超健康", "key": "峨眉 擂茶", "s": ""},
        {"name": "新竹肉圓", "desc": "城隍廟周邊肉圓，蒸煮型軟Q，沾特製醬汁", "key": "新竹 肉圓", "s": ""},
        {"name": "竹東粄粽", "desc": "客家粄粽米香濃郁，油蔥花生一口滿足", "key": "竹東 粄粽", "s": ""},
        {"name": "新豐海鮮", "desc": "新豐漁港現撈海鮮，蛤蜊、白蝦超新鮮", "key": "新豐 海鮮 漁港", "s": ""},
    ],
    "苗栗": [
        ...
        {"name": "三義木雕薯條", "desc": "三義老街特色零食，搭配木雕文化超有意思", "key": "三義 老街 小吃", "s": ""},
        {"name": "苑裡蔥油餅", "desc": "苑裡在地早餐攤，現烤蔥油餅酥脆飄香", "key": "苑裡 蔥油餅", "s": ""},
        {"name": "通霄苦茶油麵", "desc": "通霄特產苦茶油拌麵，清爽健康古早味", "key": "通霄 苦茶油麵", "s": ""},
        {"name": "客家粄條", "desc": "頭份、頭屋客家粄條，現做米香配豬油蔥", "key": "苗栗 客家粄條", "s": ""},
    ],
    "台中": [
        ...
        {"name": "筒仔米糕", "desc": "台中傳統筒仔米糕，油飯香氣醬汁超入味", "key": "台中 筒仔米糕", "s": ""},
        {"name": "清水排骨麵", "desc": "清水老街排骨麵，大塊骨肉湯底清甜名聞全台", "key": "清水 排骨麵", "s": ""},
        {"name": "豐原廟東小吃", "desc": "豐原廟東排骨酥麵、粉腸、米糕，夜市必逛", "key": "豐原廟東 小吃", "s": ""},
        {"name": "大甲芋頭", "desc": "大甲芋頭Q鬆綿密，芋頭酥、芋泥點心超受歡迎", "key": "大甲 芋頭 甜點", "s": ""},
    ],
    "彰化": [
        ...
        {"name": "鹿港蚵嗲", "desc": "鹿港特有炸物，蚵仔包麵糊現炸外酥內鮮", "key": "鹿港 蚵嗲", "s": ""},
        {"name": "員林蜜餞", "desc": "員林蜜餞街百年老味，芭樂番茄李子酸甜好吃", "key": "員林 蜜餞", "s": ""},
        {"name": "二林葡萄", "desc": "二林葡萄酒莊及鮮果，甜脆多汁秋季限定", "key": "二林 葡萄 葡萄酒", "s": "cold"},
    ],
    "南投": [
        ...
        {"name": "魚池紅茶冰淇淋", "desc": "魚池紅茶產地，茶香冰淇淋迷人不甜膩", "key": "魚池 紅茶 冰淇淋", "s": "hot"},
        {"name": "集集香蕉", "desc": "集集特產香蕉，香蕉蛋糕冰淇淋一條街", "key": "集集 香蕉 甜點", "s": ""},
        {"name": "埔里豆腐乳", "desc": "埔里名產豆腐乳，搭配白粥或配飯超下飯", "key": "埔里 豆腐乳", "s": ""},
        {"name": "國姓咖啡", "desc": "國姓鄉台灣咖啡產地，海拔風味清新帶果香", "key": "國姓 台灣咖啡", "s": ""},
    ],
    "雲林": [
        ...
        {"name": "土庫鵝肉", "desc": "土庫鵝肉飯鹹香濃郁，現殺鵝肉超鮮甜", "key": "土庫 鵝肉 飯", "s": ""},
        {"name": "西螺果菜市場", "desc": "西螺果菜批發市場，新鮮蔬果直購超划算", "key": "西螺 蔬果 市場", "s": ""},
        {"name": "林內木瓜牛奶", "desc": "林內在地木瓜香濃牛奶，比高雄版更清甜", "key": "林內 木瓜牛奶", "s": ""},
        {"name": "台西海鮮", "desc": "台西漁港現撈海鮮，蚵仔、文蛤、蝦超新鮮", "key": "台西 海鮮 漁港", "s": ""},
    ],
    "嘉義": [
        ...
        {"name": "林聰明沙鍋魚頭", "desc": "嘉義百年名店，沙鍋魚頭湯底白濁鮮甜", "key": "嘉義 林聰明 沙鍋魚頭", "s": ""},
        {"name": "嘉義涼麵", "desc": "夏日必吃，芝麻醬拌細麵配泡菜清爽解膩", "key": "嘉義 涼麵", "s": "hot"},
        {"name": "蒜頭蒜味小吃", "desc": "六腳鄉大蒜產地，蒜頭雞、蒜味肉香撲鼻", "key": "六腳 大蒜 料理", "s": ""},
        {"name": "新港飴", "desc": "新港老街百年麥芽糖，伴手禮首選甜而不膩", "key": "新港 飴 麥芽糖", "s": ""},
    ],
    "台南": [
    ...
    "屏東": [
        ...
        {"name": "車城豆腐", "desc": "車城福安宮旁豆腐餐廳，嫩豆腐各式料理超嫩滑", "key": "車城 豆腐 餐廳", "s": ""},
        {"name": "林邊黑珍珠蓮霧", "desc": "林邊特產黑珍珠蓮霧，脆甜多汁冬春限定", "key": "林邊 蓮霧 黑珍珠", "s": "cold"},
        {"name": "枋寮漁港烤飛魚", "desc": "枋寮現撈飛魚炭烤，皮酥肉鮮南台灣海味", "key": "枋寮 飛魚 海鮮", "s": ""},
        {"name": "里港豬腳", "desc": "里港豬腳與萬巒並稱雙絕，皮Q骨香滷汁甘甜", "key": "里港 豬腳", "s": ""},
    ],
    "宜蘭": [
    ...
    "澎湖": [
        ...
        {"name": "海膽料理", "desc": "澎湖海膽肥美鮮甜，拌飯或生食都頂級", "key": "澎湖 海膽", "s": ""},
        {"name": "虱目魚粥", "desc": "澎湖漁村早餐，現殺虱目魚粥清甜暖胃", "key": "澎湖 虱目魚粥", "s": ""},
    ],
    "金門": [
        ...
        {"name": "金門牛肉乾", "desc": "金門特產風乾牛肉，嚼勁十足鹹香夠味", "key": "金門 牛肉乾", "s": ""},
        {"name": "金門菜刀蚵仔煎", "desc": "金門蚵仔肥美鮮甜，現炒蚵仔煎配甜辣醬", "key": "金門 蚵仔煎", "s": ""},
        {"name": "金門一口酥", "desc": "金門糕餅老店出品，酥脆鹹甜一口剛好", "key": "金門 一口酥 糕餅", "s": ""},
    ],
    "連江": [
        ...
        {"name": "紅糟肉", "desc": "馬祖老酒紅糟醃漬炸豬肉，外酥鹹香下飯", "key": "馬祖 紅糟肉", "s": ""},
        {"name": "東引陳高蟹", "desc": "東引陳年高粱酒泡活蟹，醉蟹海味十足", "key": "馬祖 東引 醉蟹", "s": ""},
        {"name": "馬祖大閘蟹", "desc": "秋冬馬祖海域大閘蟹肥美，蒸食最鮮甜", "key": "馬祖 大閘蟹", "s": "cold"},
    ],
}  # fallback
...
def build_group_dining_message(text: str) -> list:
    ...
    text_s = text.strip()
    # 處理「更多推薦 {city} {type}」
    if text_s.startswith("更多推薦"):
        rest = text_s[4:].strip()
        city = next((c for c in _GROUP_DINING_CITIES if c in rest), "台北")
        dtype = next((t for t in _GROUP_DINING_TYPES if t in rest), "不限")
        return _build_more_restaurants(city, dtype)
...
def _build_more_restaurants(city: str, dining_type: str) -> list:
    """「更多推薦」— 顯示 6 家 Google Places 餐廳於 LINE 內"""
    info = _GROUP_DINING_TYPES.get(dining_type, _GROUP_DINING_TYPES["不限"])
    color = info["color"]
    picks: list[dict] = []
    if GOOGLE_PLACES_API_KEY:
        raw = _text_search_places(f"{city} {dining_type} 聚餐 推薦", max_results=10)
        picks = [p for p in raw if (p.get("rating") or 0) >= 3.8][:6]
    if not picks:
        return [{"type": "text", "altText": "目前無資料",
                 "text": f"目前找不到 {city} {dining_type} 的推薦資料，請稍後再試。"}]
    rows = [_gp_row(p) for p in picks]
    return [{"type": "flex", "altText": f"🔍 {city} {dining_type} 更多推薦",
             "contents": {
                 "type": "bubble", "size": "mega",
                 "header": {"type": "box", "layout": "vertical",
                             ...
                             "contents": [
                                 {"type": "text",
                                  "text": f"🔍 {city} {dining_type} 更多推薦",
                                  "color": "#FFFFFF", "size": "md", "weight": "bold"},
                                 {"type": "text", "text": "以下均為 Google 真實評分餐廳",
                 ...
                 "footer": {"type": "box", "layout": "horizontal", "spacing": "sm",
                             ...
                             "contents": [
                                 {"type": "button", "style": "link", "flex": 1, "height": "sm",
                                  "action": {"type": "message", "label": "← 回上一頁",
                                             "text": f"聚餐 {city} {dining_type}"}},
                             ]},
             }}]
...
def build_food_flex(style: str, area: str = "") -> list:
    ...
    colors = {"台式早餐": "#F57F17", "西式早餐": "#F9A825", "便當": "#C62828", "麵食": "#E65100", "小吃": "#F57C00",
              "火鍋": "#D32F2F", "日韓": "#1565C0", "早午餐": "#FF8F00",
              "飲料甜點": "#6A1B9A", "輕食": "#2E7D32", "燒烤": "#BF360C", "夜市小吃": "#37474F", "炸物": "#E65100",
              "粥": "#78909C", "拉麵": "#E53935", "港式": "#D84315", "義式": "#558B2F", "素食": "#388E3C", "麵包蛋糕": "#F9A825"}
    color = colors.get(style, "#FF8C42")
    icons = {"台式早餐": "🥚", "西式早餐": "🍳", "便當": "🍱", "麵食": "🍜", "小吃": "🥘", "火鍋": "🍲",
             "日韓": "🍣", "早午餐": "☕", "飲料甜點": "🧋", "輕食": "🥗",
             "燒烤": "🔥", "夜市小吃": "🌙"}
...
def build_trending_specialty(city: str, mode: str) -> list:
    ...
    # ── 1. 優先：_CITY_SPECIALTIES 靜態在地資料 ─────────────────────────────
    pool = _CITY_SPECIALTIES.get(city, _CITY_SPECIALTIES.get(city2, []))
    if pool:
        if is_souvenir:
            items = [it for it in pool if any(kw in it.get("desc", "") for kw in _SOUVENIR_DESC_KW)]
            if not items:
                items = pool  # 該城市全是小吃，全部顯示
        else:
            items = pool  # 最新流行 = 全部在地特色

        # 取 Places 資料（photo + rating），與 build_city_specialties 共用同一組 Redis 快取
        batch = items[:8]
        keys = [it.get("key", it["name"]) for it in batch]

        def _fetch_place_local(key: str) -> dict:
            cache_key = f"specialty_place:{key}"
            cached = _redis_get(cache_key)
            if cached:
                return json.loads(cached) if isinstance(cached, str) else cached
            ...
            if results:
                r = results[0]
                data = {"photo_ref": r.get("photo_ref", ""),
                        "rating": r.get("rating", 0),
                        "reviews": r.get("user_ratings_total", 0)}
            _redis_set(cache_key, json.dumps(data), ttl=7 * 86400)
            return data
        ...
        def _item_bubble(item: dict, place: dict) -> dict:
            tag = "🛍 必買伴手禮" if is_souvenir else "🔥 最新流行"
            photo_url = _places_photo_url(place.get("photo_ref", "")) if place.get("photo_ref") else ""
            rating = place.get("rating", 0)
            reviews = place.get("reviews", 0)

            if rating >= 4.5 and reviews >= 100:
                rating_str, rating_color = f"★{rating}  ({reviews}則)", "#E53935"
            elif rating >= 4.0:
                rating_str, rating_color = f"★{rating}  ({reviews}則)" if reviews else f"★{rating}", "#F57C00"
            elif rating:
                rating_str, rating_color = f"★{rating}", "#888888"
            else:
                rating_str, rating_color = "", "#888888"
            ...
            if rating_str:
                body_contents.append({"type": "text", "text": rating_str,
                                       "size": "xs", "color": rating_color, "margin": "sm"})
            ...
            bubble: dict = {
                ...
                "footer": {
                    ...
                    "contents": [{
                        ...
                        "color": "#FF6B35", "height": "sm",
                        "action": {"type": "message", "label": "🏆 找名店推薦",
                                   "text": f"特色名店 {city2} {item['name']}"},
                    }]},
            }
            if photo_url:
                bubble["hero"] = {"type": "image", "url": photo_url,
                                   "size": "full", "aspectRatio": "20:13", "aspectMode": "cover"}
            return bubble
...
def build_food_region_picker(style: str) -> list:
    ...
    colors = {"台式早餐": "#F57F17", "西式早餐": "#F9A825", "便當": "#C62828", "麵食": "#E65100", "小吃": "#F57C00",
              ...
              "夜市小吃": "#37474F", "炸物": "#E65100", "餐廳": "#6D4C41",
              "粥": "#78909C", "拉麵": "#E53935", "港式": "#D84315", "義式": "#558B2F", "素食": "#388E3C", "麵包蛋糕": "#F9A825"}
